...
from socialapi.task import generate_and_add_to_post
...
async def create_post(
    ...
    if prompt:
        # Log the background task addition
        logger.info(
            f"Adding background task for post ID {last_record_id} with prompt: {prompt}"
        )
